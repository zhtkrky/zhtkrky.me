      ...
      >
        {Object.values(projects).map((project) => (
          <a
            ...
            href={project.link}
            target="_blank"
            className="flex justify-start w-full sm:w-1/2 gap-4 items-center dark:hover:bg-neutral-900 hover:bg-neutral-100 p-4 rounded-md no-underline"
          >
            ...
            <div className="flex flex-col">
              <div className="flex items-center">
                ...
                <div className="w-4 h-4 hidden md:block">{externalIcon}</div>
              </div>
